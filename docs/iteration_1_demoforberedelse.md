...
- Iteration 3 (BIE-cykel 3): Feedback från designcykel 2:s utvärdering + tvådimensionsoperationalisering, FP-baslinjereduktion och empirisk tröskelkalibrering. Formalization of Learning (formalisering av designprinciper som Generalized Outcomes) är en separat fas efter iteration 3.
