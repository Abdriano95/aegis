...
| [#105](https://github.com/Abdriano95/aegis/issues/105) (I-5) | Tvådimensionsoperationalisering enligt Variant 2 | A3 | Gemensamt | 🔄 Pågår (uppdelad i tre commits: Del 1 Core + SSOT, Del 2 aggregator + `derive_sensitivity`, Del 3 demo + evaluation) | I-3 | Villkorad DP6 (5.5); 5.3 klassdiagram och 4.4.3 uppdateras. |
