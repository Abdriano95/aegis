...
1. Claude skriver en strukturerad Claude Code-prompt för nästa issue,
   med kontext, specifikation, regler, arbetsflöde och definition
   of done.

2. Användare klistrar in prompten i Claude Code (Plan Mode).

3. Claude Code genererar en plan. Användare kopierar planen tillbaka
   till Claude.

4. Claude verifierar planen mot arkitektur.md och flaggar
   eventuella avvikelser. Om den stämmer: "Stämmer. Kör den."

5. Användare kör planen i Claude Code (Agent Mode).
...
9. Användare skriver sessionspost i
   docs/iteration_N_implementation.md och uppdaterar
   issue-status till ✅ Klar med datum. Designbeslut
   förs in i Loggboken med motivering.
...
Claude ska inte generera kod direkt - Claude Code gör implementationen.
